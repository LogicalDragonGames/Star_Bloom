...
{
	public class DiaQDecisionTreeEd
	{
		private static readonly string[] ValTypeNames1 = { "True", "False" };
		private static readonly string[] ValTypeNames2 = { "Empty", "Value", "DiaQVar" };

		[HideInInspector]
		public static readonly string[] TestTypeNames = { "==", "!=", ">", "<", ">=", "<=" };
		
		public static void OnGUI(EditorWindow ed, DiaQDecisionTree d, DiaQAsset asset, float areaWidth)
		{
		...
		private static void ShowVariableField(EditorWindow ed, DiaQDecisionTest t, DiaQAsset asset, float w)
		{
			...
			{
				t.testType = (DiaQDecisionTest.TestType)EditorGUILayout.Popup((int)t.testType, TestTypeNames, EditorStyles.miniButtonMid, GUILayout.Width(30));
			}
